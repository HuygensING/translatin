...
@language=la
@levelConstraints=note < chunk, p; salute < opener, closer; teiHeader < chapter; div < chapter; head < chunk; p < chunk; fileDesc < chunk; profileDesc < chunk; div < chunk
@schema=TEI + translatin
@sectionFeatures=drama,part,chunk
@sectionTypes=drama,part,chunk
@sourceFormat=TEI
