...
@language=la
@levelConstraints=note < chunk, p; salute < opener, closer; teiHeader < chapter; div < chapter; profileDesc < chunk; head < chunk; fileDesc < chunk; p < chunk
...
@dateWritten=2025-02-19T12:33:14+00:00Z
