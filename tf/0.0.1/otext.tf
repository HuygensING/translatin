...
@language=la
@levelConstraints=note < chunk, p; salute < opener, closer; teiHeader < chapter; div < chapter; profileDesc < chunk; p < chunk; head < chunk; fileDesc < chunk
...
@dateWritten=2025-02-19T13:25:32+00:00Z
